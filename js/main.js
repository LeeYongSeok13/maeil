window.addEventListener("DOMContentLoaded", function () {
  ...
  const MainSlider = new Swiper(".MainSlider", {
    ...
    on: {
      slideChangeTransitionEnd: function () {
        ...
        SS.forEach((e) => e.classList.remove("on"));
  ...
  let brandLi01 = document.querySelector(
    "#brand .container ul li:nth-child(1)"
  );
  let brandLi02 = document.querySelector(
    "#brand .container ul li:nth-child(2)"
  );
  let brandLi03 = document.querySelector(
    "#brand .container ul li:nth-child(3)"
  );
  let brandLi04 = document.querySelector(
    "#brand .container ul li:nth-child(4)"
  );
  brandLi01.addEventListener("mouseover", function () {
    brandBg.style.backgroundImg = "url('../img/brand_bg01.jpg')";
  });

  brandLi02.addEventListener("mouseover", function () {
    brandBg.style.backgroundImg = "url('../img/brand_bg02.jpg')";
  });

  brandLi03.addEventListener("mouseover", function () {
    brandBg.style.backgroundImg = `url('../img/brand_bg03.jpg')`;
  });

  brandLi04.addEventListener("mouseover", function () {
    brandBg.style.backgroundImg = `url('../img/brand_bg04.jpg')`;
  });
